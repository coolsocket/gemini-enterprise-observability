...
"""View registry — the catalogue of public v_* / s_* BigQuery views.

Moved from apps/api/shared/common.py (2026-07-06, Phase 3 of the TDDD
refactor) so the observability context owns its own vocabulary. The
shared/common.py module re-exports these names for backwards compat.

Pure module: no I/O, no logging, no framework imports. Suitable to be
imported from tests, migrations, and future contexts without pulling
BigQuery client / FastAPI along for the ride.
"""
